...
bool CMSIS_SPI_Data_Transmit(SPI_TypeDef *SPI, uint8_t* data, uint16_t Size_data, uint32_t Timeout_ms); //Функция отправки данных по SPI (Стандартная)
bool CMSIS_SPI_Data_Receive(SPI_TypeDef *SPI, uint8_t* data, uint16_t Size_data, uint32_t Timeout_ms); //Функция приема данных по SPI (Стандартная)
